...
class GlobalConfig:
    ...
    # Conv Encoder
    vert_anchors_s = 12 #transfuser = 8 (256); fuseattention = 7(224); fuseattention = 16(512) 
    horz_anchors_s = 12

    vert_anchors_l = 16 #transfuser = 8 (256); fuseattention = 7(224); fuseattention = 16(512) 
    horz_anchors_l = 16
    ...
    n_head = 8 # ori=4
    n_scale = 4
    embd_pdrop = 0.0 # original setup = 0.1
    resid_pdrop = 0.0 #ori = 1
    attn_pdrop = 0.0 # ori=1
